...
fbc                     = [8,9,10,11,14,15,16,17];       % index of fixed nodes
fbn                     = 0.5           ;                  % magnitude of external forces
NB                      = [75,76]       ;                  % nodes with extermal forces
...
%% Grid generation
NN(1,1)                 = 6;                               % number of nodes in X direction
NN(1,2)                 = 15;                               % number of nodes in Y direction
